...
<head>
    <meta charset="utf-8">
    <title>bower_components/webcomponentsjs/webcomponents-lite.min.js - {{project_name}}</title>
    ...
    <div id="bd" class="yui3-g">
        ...
        <div class="yui3-u-3-4">
            ...
            <div class="apidocs">
                <div id="docs-main">
                    <div class="content">
<h1 class="file-heading">File: bower_components/webcomponentsjs/webcomponents-lite.min.js</h1>
